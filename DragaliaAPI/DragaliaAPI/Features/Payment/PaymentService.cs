...
) : IPaymentService
{
    ...
    {
        return this.ProcessPayment(new Entity(EntityTypes.Material, (int)id, quantity));
    }

    public DeleteDataList GetDeleteDataList()
    {
        return new DeleteDataList(this.dragonList, this.talismanList, this.weaponList, this.amuletList);
    }
}
