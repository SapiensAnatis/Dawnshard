        ...
        storedSavefile
            ...
            .BeEquivalentTo(
                ...
                opts =>
                {
                    ...
                    opts.Excluding(x => x.user_data!.ViewerId);
                    ...
                    opts.Excluding(x => x.user_data!.LastLoginTime);
                    ...
                    opts.Excluding(x => x.user_data!.StaminaSingle);
                    opts.Excluding(x => x.user_data!.StaminaMulti);
                    opts.Excluding(x =>
                    ...
                    opts.Excluding(x => x.user_data!.ActiveMemoryEventId);

                    opts.Excluding(x => x.user_data!.FortOpenTime);

                    // Ignored properties
                    opts.Excluding(x => x.user_data!.PrologueEndTime);
