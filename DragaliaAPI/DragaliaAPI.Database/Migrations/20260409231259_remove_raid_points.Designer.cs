...
namespace DragaliaAPI.Database.Migrations
{
    ...
    [Migration("20260409231259_remove_raid_points")]
    partial class remove_raid_points
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DragaliaAPI.Database.Entities.DbPlayerCharaHonor", b =>
                {
                    b.Property<long>("ViewerId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("ViewerId", "CharaId", "HonorId");

                    b.ToTable("PlayerCharaHonor");
                });
            ...
            modelBuilder.Entity("DragaliaAPI.Database.Entities.DbPlayerEventSummonData", b =>
                {
                    b.Property<long>("ViewerId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PlayerEventSummonData");
                });

            modelBuilder.Entity("DragaliaAPI.Database.Entities.DbPlayerEventSummonItem", b =>
                {
                    b.Property<long>("ViewerId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("TimesSummoned")
                        .HasColumnType("integer");

                    b.HasKey("ViewerId", "EventId", "ItemId");

                    b.ToTable("PlayerEventSummonItems");
                });
            ...
            modelBuilder.Entity("DragaliaAPI.Database.Entities.DbPlayerEventSummonItem", b =>
                {
                    b.HasOne("DragaliaAPI.Database.Entities.DbPlayerEventSummonData", "EventSummonData")
                        .WithMany("Items")
                        .HasForeignKey("ViewerId", "EventId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("EventSummonData");
                });
