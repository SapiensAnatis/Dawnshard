...
public class EventDropService(IEventRepository eventRepository)
{
    ...
    private IEnumerable<DropEntity> GenerateBuildEventDrops(QuestData quest, EventData evt)
    {
        ...
        if (type == DungeonTypes.Wave)
        {
            ...
            yield return new(evt.ViewEntityId3, evt.ViewEntityType3, t3Quantity);
        }
        ...
        yield return new(evt.ViewEntityId2, evt.ViewEntityType2, t2Quantity);
        ...
        yield return new(evt.ViewEntityId1, evt.ViewEntityType1, t1Quantity);
    ...
    private IEnumerable<DropEntity> GenerateRaidEventDrops(QuestData quest, EventData evt)
    {
        ...
        switch (type)
        {
            ...
            case DungeonTypes.Raid or DungeonTypes.RaidSingle:
            {
                ...
                yield return new(itemId, EntityTypes.RaidEventItem, emblem2Quantity);
                break;
            }
        }
