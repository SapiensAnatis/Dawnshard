...
public static class UnitAvailabilityExtensions
{
    ...
    private static readonly FrozenDictionary<Dragons, UnitAvailability> DragonAvailabilityMap =
        new Dictionary<Dragons, UnitAvailability>()
        {
            ...
            // Gala units
            [Dragons.GalaMars] = UnitAvailability.Limited,
            [Dragons.GalaCatSith] = UnitAvailability.Limited,
            [Dragons.GalaThor] = UnitAvailability.Limited,
            [Dragons.GalaRebornPoseidon] = UnitAvailability.Limited,
            [Dragons.GalaRebornZephyr] = UnitAvailability.Limited,
            [Dragons.GalaRebornJeanne] = UnitAvailability.Limited,
            [Dragons.GalaRebornAgni] = UnitAvailability.Limited,
            [Dragons.GalaRebornNidhogg] = UnitAvailability.Limited,
            [Dragons.GalaBeastVolk] = UnitAvailability.Limited,
            [Dragons.GalaBahamut] = UnitAvailability.Limited,
            [Dragons.GalaChronosNyx] = UnitAvailability.Limited,
            [Dragons.GalaBeastCiella] = UnitAvailability.Limited,
            [Dragons.GalaElysium] = UnitAvailability.Limited,
