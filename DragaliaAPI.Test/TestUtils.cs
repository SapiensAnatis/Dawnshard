...
{
    /// <summary>
    /// Cast the data of a <see cref="ActionResult{TValue}"/> to a given type.
        ...
        where T : class
    {
        DragaliaResponse<object> innerResponse =
            (DragaliaResponse<object>)((OkObjectResult)response.Result!).Value!;
        return (T)innerResponse.data;
    }
