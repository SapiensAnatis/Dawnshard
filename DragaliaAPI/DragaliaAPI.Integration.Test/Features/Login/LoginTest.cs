...
public class LoginTest : FakeTimeProviderTestFixture
{
    ...
    public async Task LoginIndex_LastLoginBeforeReset_ResetsDragonGiftCount()
    {
        ...
        this.FakeTimeProvider.AdjustTime(new(2049, 03, 16, 02, 13, 59, TimeSpan.Zero)); // Into Tuesday, but last reset was Monday
    ...
    public async Task LoginIndex_LastLoginBeforeReset_NoDragonGifts_ResetsDragonGiftCount()
    {
        ...
        this.FakeTimeProvider.AdjustTime(new(2049, 03, 15, 23, 13, 59, TimeSpan.Zero)); // Monday
    ...
    public async Task LoginIndex_LastLoginBeforeReset_Saturday_ResetsGoldenChalice()
    {
        ...
        this.FakeTimeProvider.AdjustTime(new(2049, 03, 14, 23, 13, 59, TimeSpan.Zero)); // Sunday
    ...
    {
        this.FakeTimeProvider.AdjustTime(DateTime.Parse("2018/09/28").ToUniversalTime());
