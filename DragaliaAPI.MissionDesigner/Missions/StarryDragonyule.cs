...
public static class StarryDragonyule
{
    ...
    public static List<Mission> PeriodMissions { get; } =
        [
            ...
            /* new ClearAllStoryQuestsMission */
            // Collect 1,000 Heroism in One Invasion
            new EventPointCollectionMission() { MissionId = 11650301, EventId = EventId },
            // Collect 2,000 Heroism in One Invasion
            new EventPointCollectionMission() { MissionId = 11650302, EventId = EventId },
            // Collect 3,000 Heroism in One Invasion
            new EventPointCollectionMission() { MissionId = 11650303, EventId = EventId },
            // Collect 4,000 Heroism in One Invasion
            new EventPointCollectionMission() { MissionId = 11650304, EventId = EventId },
            // Collect 5,000 Heroism in One Invasion
            new EventPointCollectionMission() { MissionId = 11650305, EventId = EventId },
            // Defeat 1,000 Enemies in Invasions
            /* new EarnEnemyKillMission() */
