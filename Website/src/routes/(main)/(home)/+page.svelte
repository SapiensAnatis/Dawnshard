...
<div class="p-5 md:w-[75%]">
	<Typography typography="h2">About</Typography>
	<p>
		Dawnshard is attempting to reimplement the server infrastructure of Dragalia Lost. It aims to do
		so in a vanilla fashion, i.e. with limited changes to the original mechanics of the game. Though
		not all features are yet implemented, the game is in a playable state and it is possible to
		progress largely as normal.
	</p>

	<Typography typography="h2" class="mt-6">How to play</Typography>
	<p>
		Setting up access to the server involves configuring a modified version of the original Dragalia
		Lost app to connect to this server at{' '}
		<a class="link" href="https://dawnshard.co.uk">https://dawnshard.co.uk</a>. It is possible to do
		so on both Android and iOS without jail-breaking or rooting your device. It is also possible to
		do this on an Android emulator, even though the original game could not be played on emulators.
		If you encounter any issues during the set-up process, consider joining the{' '}
		<a class="link" href="https://discord.gg/j9zSttjjWj">community Discord server</a>.
	</p>

	<Typography typography="h3" class="mt-4">Android</Typography>
	<aside class="float-none mb-4 ml-4 flex w-full flex-col items-center md:float-right md:w-fit">
		<enhanced:img
	...
	<ol class="list-decimal px-8">
		<li>
			Ensure you have the original Dragalia Lost app installed. The Dragalipatch app works by taking
			the files from the original app and modifying them.
		</li>
		<li>
		...
		<li>
			Wait for the app to finish patching the Dragalia Lost app. Once it is done, press Install on
			the screen that follows.
		</li>
	</ol>

	<Typography typography="h3" class="mt-4">iOS</Typography>
	<p>
		...
		<a class="link" href="https://sideloadly.io/">Sideloadly</a> to install a pre-patched IPA file that
		allows configuring the server address.
	</p>
	<Typography typography="h2" class="mb-6 mt-6">Frequently asked questions</Typography>
	...
	<Typography typography="h2" class="mt-6">Acknowledgements</Typography>
	<p>
	...
	<ul class="ml-3 mt-1">
		<Acknowledgement name="LukeFZ" avatarSrc={LukeFZ}>
			for developing the BaaS account system, DragaliPatch, and implementing features including the
			event compendium, endeavours, and more.
		</Acknowledgement>
