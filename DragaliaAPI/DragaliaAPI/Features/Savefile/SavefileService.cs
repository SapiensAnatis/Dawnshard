...
public class SavefileService : ISavefileService
{
    ...
    public async Task Import(LoadIndexResponse savefile)
    {
        ...
        try
        {
            ...
            player.AbilityCrestList.AddRange(savefile.AbilityCrestList.Map<DbAbilityCrest>(this.mapper));
            ...
            player.StoryStates.AddRange(savefile.QuestStoryList.Map<DbPlayerStoryState>(this.mapper));
            ...
            player.StoryStates.AddRange(savefile.UnitStoryList.Map<DbPlayerStoryState>(this.mapper));
            ...
            player.StoryStates.AddRange(savefile.CastleStoryList.Map<DbPlayerStoryState>(this.mapper));
            ...
            player.DragonGiftList.AddRange(savefile.DragonGiftList.Map<DbPlayerDragonGift>(this.mapper));
            ...
            player.EquippedStampList.AddRange(savefile.EquipStampList.Map<DbEquippedStamp>(this.mapper));
            ...
            player.SummonTickets.AddRange(savefile.SummonTicketList.Map<DbSummonTicket>(this.mapper));
            ...
            player.QuestTreasureList = savefile.QuestTreasureList.Map<DbQuestTreasureList>(this.mapper);
